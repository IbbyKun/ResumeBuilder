        ...
        >
          <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
            <h1
              ...
              style={{ textAlign: 'left', marginLeft: '40px', fontFamily: 'Judson' }}
            >
              Parse your resumes with us easily
            </h1>
            <p
              className="text-lg mb-6"
              style={{ textAlign: 'left', marginLeft: '40px', fontFamily: 'Judson' }}
            >
              With this free, open-source and powerful AI based resume parser
            </p>
            <button
          ...
          <div className="md:w-1/2 flex justify-center">
            <img src="https://placehold.co/400x300" alt="Illustration" className="w-full max-w-md" />
          </div>
        </div>

        {/* Login Or SignUp Option */}
        <div className="flex flex-col items-center justify-center h-screen text-white">
          <h1 className="text-3xl md:text-5xl font-bold mb-8" style={{ fontFamily: 'Judson' }}>
            Let's start our Journey!
          </h1>
          <br />
          <div className="flex space-x-12 md:space-x-16 gap-8">
            <button
              className="border border-white rounded-full px-6 py-2 text-lg hover:bg-white hover:text-blue-900 transition"
            >
              Sign-up
            </button>

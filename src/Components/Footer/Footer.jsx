        ...
        <Box
            ...
            <Container
                ...
                <Stack direction={'row'} spacing={6}>
                    <SocialButton label={'Github'} href={'https://github.com/IbbyKun/ResumeBuilder'}>
                        <FaGithub />
                    </SocialButton>
                    <SocialButton label={'Snapchat'} href={'https://x.com/'}>
                        <FaSnapchat />
                    </SocialButton>
                    <SocialButton label={'Instagram'} href={'https://instagram.com/talha_zahid_'}>
                        <FaInstagram />
                    </SocialButton>
                </Stack>
            </Container>
